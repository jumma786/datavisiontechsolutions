...
(function () {
  ...
  var RULES = [
    ...
    { k: ["catalytic", "converter", "cat con"],
      a: 'Yes, we buy <b>catalytic converters</b>. Values vary widely by vehicle and unit, so send us a photo of the cat (and any code stamped on it) and we’ll give you a current price. ' + CONTACT },
    { k: ["public", "householder", "household", "domestic", "private individual", "member of the public", "homeowner", "not a business", "individual"],
      a: 'Yes — we buy from <b>both trade and members of the public</b>. You’ll just need valid photo ID, and payment is by bank transfer (cash isn’t permitted by law). ' + CONTACT },
    { k: ["trade account", "merchant", "regular supply", "regular collection", "business account", "ongoing", "contract", "wholesale", "bulk supply", "scrap yard", "supplier"],
      a: 'Absolutely — we work with scrap yards, merchants, factories and trade suppliers regularly and can set up <b>ongoing collections</b> on agreed terms. ' + CONTACT },
    ...
    { k: ["waste transfer", "transfer note", "wtn", "duty of care", "duty-of-care", "paperwork", "documentation", "receipt", "audit trail", "consignment"],
      a: 'Yes — we issue a <b>waste transfer note</b> on every collection, giving you a full audit trail and meeting your duty-of-care obligations. We’re an Environment Agency registered carrier (CBDU622654).' },
    { k: ["minimum", "small load", "small amount", "small quantity", "too small", "little bit", "few kilos", "not much", "how much do i need", "is there a min"],
      a: 'There’s no strict minimum, though free collection is aimed at trade and larger loads. For smaller amounts you’re welcome to deliver to us, or we’ll advise the best option — tell us roughly how much you have. ' + CONTACT },
    { k: ["container", "skip", "cage", "stillage", "roro", "drop off a", "bins for"],
      a: 'For regular suppliers and larger jobs we can arrange <b>containers, cages or stillages</b> for your metal. Tell us your site, the metal type and rough volume and we’ll set up the right solution. ' + CONTACT },
    { k: ["weigh", "weighed", "weighbridge", "weighbridge", "scales", "tonnage", "how heavy"],
      a: 'All material is weighed on <b>certified, calibrated scales</b> — or a public weighbridge for larger loads — and the weight is shown on your documentation, so it’s fully transparent. ' + CONTACT },
    { k: ["environment", "environmental", "recycle", "recycling", "sustainab", "what happens to", "carbon", "responsib", "reused", "circular", "eco"],
      a: 'Everything we buy is processed and <b>recycled responsibly</b> through our ISO 9001:2015 certified facility and returned to industry as raw material — a genuine closed-loop, circular supply chain.' },
    { k: ["stolen", "proof of ownership", "ownership", "legitimate", "theft", "where did it come from", "is it legal to sell"],
      a: 'We only buy metal from its <b>lawful owner</b> and record seller ID on every transaction, as the law requires. If you own the material or are authorised to sell it, you’re fine — just bring valid photo ID. ' + CONTACT },
    { k: ["how quick", "how fast", "how soon", "how long", "response time", "when can you come", "same day", "turnaround", "wait"],
      a: 'We aim to respond to quotes the <b>same day</b>, and can often arrange collection within a day or two depending on your location and load. The fastest way to reach us is WhatsApp or a call. ' + CONTACT },
